...
async function Create(Data) {
    ...
    let sqsDiemData = {
        ...
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/' + accountId + '/InsertPhanCong',
    };
...
async function Delete(MaGV, MaMon, MaLop) {
    ...
    let sqsDiemData = {
        ...
        MessageBody: JSON.stringify(DiemData),
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/' + accountId + '/DeletePhanCong',
    };
...
async function Update(MaGV, MaMon, MaLop) {
    ...
    let sqsDiemData = {
        ...
        MessageBody: JSON.stringify(DiemData),
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/' + accountId + '/UpdatePhanCong',
    };
